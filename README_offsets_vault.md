# LabCal — offsets vault, jobsheet worklist, iPad saving, day panel (v1.31)
...
| `sw.js` | Cache bumped to **v26**, caches all shared modules |
...
picks up v26, then hit **Refresh offline copy**.
